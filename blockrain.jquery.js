...
((function ( $ ) {
  ...
  $.widget('aerolab.blockrain', {
    ...
    options: {
      ...
      theme: 'retro' , //null, 'gameboy', // The theme name or a theme object
...
window.BlockrainThemes = {
  'texture': {
    background: '#040304',
    backgroundGrid: 'data:image/png;base64,',
    complexBlocks: {
      line:     ['assets/blocks/texture/line.png', 'assets/blocks/texture/line.png'],
      square:   ['assets/blocks/texture/square.png'],
      arrow:    'assets/blocks/texture/arrow.png',
      rightHook:['assets/blocks/texture/rightHook.png'],
      leftHook: 'assets/blocks/texture/leftHook.png',
      rightZag: ['assets/blocks/texture/rightZag.png'],
      leftZag:  'assets/blocks/texture/leftZag.png'
    }
  },
  'custom': {
    background: '#040304',
